...
import bardome from '../assets/bardome.jpg'
import bardome2 from '../assets/bardome2.jpg'
...
import truckdust from '../assets/truckdust.jpg'
...
class About extends Component {
    ...
    render() {
        return (
            <div>
                <h1>We are Camp Awesomesauce</h1>
                ...
                <img style={{ width: '80vw' }} src={VR} alt="VR" />
                ...
                <img style={{ width: '80vw' }} src={wedding2} alt="wedding2" />
                <img style={{ width: '80vw' }} src={bardome2} alt="bardome2" />
                <img style={{ width: '80vw' }} src={awesomeballs} alt="awesomeballs" />
                <img style={{ width: '80vw' }} src={garrett} alt="garrett" />
                <img style={{ width: '80vw' }} src={elephant} alt="elephant" />
                <img style={{ width: '80vw' }} src={bardome} alt="bardome" />
                <img style={{ width: '80vw' }} src={genderbender} alt="genderbender" />
